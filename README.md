...
Fullstack developer focused on building robust APIs and modern web interfaces.
I work with microservices architecture, containerized deployments, and CI/CD pipelines —
prioritizing performance, scalability, and clean code.

    🔧 Building Java/Spring Boot microservices + Angular frontends
    ...
    🗄️ Working with relational databases and multi-environment infrastructure
    📍 Blumenau, SC — Brazil
